...
/***/ function(module, exports, __webpack_require__) {
	...
	var _activity = __webpack_require__(168);
	...
	window.addEventListener('load', function () {
	    _reactDom2.default.render(_react2.default.createElement(_activity2.default, null), document.getElementById('app'));
	});
	...
	var Activity = function (_Component) {
	    ...
	    _createClass(Activity, [{
	        ...
	        value: function clickHandle() {
	            alert('关于我们');
	            console.log(_reactDom2.default.findDOMNode(this).style.backgroundColor = 'red');
	        }
	    }, {
	        key: "render",
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    "div",
	                    { className: "img-wrap" },
	                    _react2.default.createElement("img", { src: "http://m.tepin.hk/client/asset/images/gywm.gif" })
	                ),
	                _react2.default.createElement(
	                    "p",
	                    null,
	                    "友阿海外购是由深交所上市公司湖南友谊阿波罗商业股份有限公司投资亿元建设的O2O跨境电商平台，2015年6月13日正式上线。海外购所售商品涵盖母婴用品、美容彩妆、营养保健、家居个护、国际轻奢等多个品类,消费者可直接在友阿海外购上买到来自英国、美国、德国、荷兰、日本等22个国家和地区的海外正品。友阿海外购以“足不出户 轻松淘遍海外尖货”为目标，为全国的海淘用户提供更为便捷、安全和实惠的海外正品购物体验。"
	                ),
	                _react2.default.createElement(
	                    "div",
	                    { className: "m-entry" },
	                ...
	                _react2.default.createElement(
	                    "p",
	                    null,
	                    "友阿海外购所售商品均为：原产地直采、保税区发货、海外直邮，品质有保障、海关监管、极速直达、国内售后。"
	                ),
	                _react2.default.createElement(
	                    "p",
	                    null,
	                    "友阿海外购坚持“线上支付+线下体验”的O2O模式，除线上销售，目前友阿海外购同时在友阿旗下门店开出家O2O跨境电商体验店，让消费者对海淘流程的每环节了然于心，并在体验店中就可现场了解或体验到商品实物，再进行线上下单，保证“所见即所购”。"
	                ),
	                _react2.default.createElement(
	                    "p",
	                    null,
	                    "友阿海外购秉承着友阿诚信为本，顾客至上的的经营理念，为广大客户提供最优质的商品和服务，立志成为中国跨境电子商务的领头羊，让每一个消费者都能买到放心、优质、舒心的海外商品。"
	                ),
	                _react2.default.createElement(
	                    "div",
	                    { className: "copyright" },
